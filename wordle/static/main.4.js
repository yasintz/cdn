          ...
          o(t, [
              ...
              value: function () {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = s), !Ta.includes(e) && !La.includes(e))) {
                    window.$wordle.event.emit('invalid-guess', {
                      line: e,
                    });
                    return (
            ...
            },
            {
              ...
              value: function () {
                ...
                window.$wordle.event.on('remove-letter', () =>
                  e.removeLetter()
                );

                window.$wordle.event.on('submit-guess', () => e.submitGuess());
                window.$wordle.event.on('add-letter', (s) => {
                  if (Ba.includes(s.toLowerCase())) {
