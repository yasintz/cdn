...
export const LessonCard: React.FC<LessonCardProps> = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl p-0 shadow-xl border-4 ${getBorderColor(
        lesson
      )} overflow-hidden transition-all duration-300 hover:shadow-2xl relative`}
    >
      {/* Card Header */}
      <div
        className={`${lessonColors[lesson]} p-6 border-b-2 ${getBorderColor(
          lesson
        )}/20 relative`}
      >
        ...
        <div className="flex items-center gap-3 mb-2">
          <span className="text-3xl">{lessonIcons[lesson]}</span>
